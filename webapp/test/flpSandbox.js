		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#axelerareadxmlfile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"axelerareadxmlfile-display": {
								"semanticObject": "axelerareadxmlfile",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=axelera.readxmlfile",
									"url": sap.ui.require.toUrl("axelera/readxmlfile")
								}
							}
						}
					}
